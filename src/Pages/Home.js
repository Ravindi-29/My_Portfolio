  ...
  return (
    <div className="home">
          ...
          <div className="buttons">
              <Link to="/contacts" className="btn primary">Hire Me</a>
              <Link to="/about" className="btn secondary">Experience</a>
              <Link to="/projects" className="btn secondary">View Projects</a>
